...
<form method="POST" action="index.php?action=register">
  ...
  <div class="mb-3">
    <label for="first_name" class="form-label small fw-medium text-secondary mb-1">First name</label>
    <input type="text" class="form-control rounded-xl py-2 shadow-none" id="first_name" name="first_name" required autocomplete="given-name">
  </div>

  <div class="mb-3">
    <label for="last_name" class="form-label small fw-medium text-secondary mb-1">Last name</label>
    <input type="text" class="form-control rounded-xl py-2 shadow-none" id="last_name" name="last_name" required autocomplete="family-name">
  </div>
