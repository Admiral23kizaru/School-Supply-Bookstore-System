<aside class="sidebar" :class="mobileMenuOpen ? 'sidebar-open' : ''">
    <div class="brand d-flex align-items-center justify-content-between gap-3">
        <div class="d-flex align-items-center gap-3">
            ...
            <div>
                School Supply<small>Super Admin Panel</small>
            </div>
        </div>
    ...
    <a class="nav-link-custom <?= $tab === 'dashboard' ? 'active' : '' ?>" href="dashboard.php?tab=dashboard">
        <i class="bi bi-grid"></i>Dashboard
    </a>
    <a class="nav-link-custom <?= $tab === 'users' ? 'active' : '' ?>" href="dashboard.php?tab=users">
    ...
    <a class="nav-link-custom <?= $tab === 'products' ? 'active' : '' ?>" href="dashboard.php?tab=products">
    ...
    <div class="menu-label">Audit & Reports</div>
    <a class="nav-link-custom <?= $tab === 'reports' ? 'active' : '' ?>" href="dashboard.php?tab=reports">
        <i class="bi bi-bar-chart"></i>Reports
    </a>
    <a class="nav-link-custom <?= $tab === 'activity_logs' ? 'active' : '' ?>" href="dashboard.php?tab=activity_logs">
