    ...
    <div class="card-custom bg-white d-flex flex-column mb-4 border-0 shadow-sm" style="min-height: 400px; flex-grow: 1;">
        ...
        <div class="px-4 py-3 border-top d-flex align-items-center justify-content-between mt-auto">
            ...
            <div class="d-flex align-items-center gap-1">
                ...
                <button class="btn btn-sm bg-dark-custom text-white d-flex align-items-center justify-content-center rounded-2 shadow-none" style="width: 30px; height: 30px; font-weight:700;" x-text="orderPage"></button>
                <button class="btn btn-sm btn-link text-secondary text-decoration-none d-flex align-items-center gap-1 shadow-none" @click="nextOrderPage" :disabled="orderPage >= totalOrderPages">Next <i class="bi bi-chevron-right"></i></button>
            </div>
        </div>
    </div>
</div>
